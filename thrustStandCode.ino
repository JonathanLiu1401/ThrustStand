...
void loop() {
  ...
  if (scale.is_ready()) {
    ...
    /* HYBRID FORMAT: Readable Text + Plotter Compatible
  ...
  if (Serial.available()) {
    ...
    // Note: We removed the "Calibration increased" text print here
    // to prevent the graph from glitching during adjustments.
  }
}